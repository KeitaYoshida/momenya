...
type SiteSiteMetadataFieldSelector = {
  readonly adsense: InputMaybe<FieldSelectorEnum>;
...
type SiteSiteMetadataFilterInput = {
  readonly adsense: InputMaybe<StringQueryOperatorInput>;
...
type SiteSiteMetadataSortInput = {
  readonly adsense: InputMaybe<SortOrderEnum>;
...
type IndexQueryQuery = { readonly site: { readonly meta: { readonly title: string | null, readonly description: string | null, readonly siteUrl: string | null, readonly author: string | null, readonly twitter: string | null, readonly adsense: string | null } | null } | null };
...
type PostByPathQuery = { readonly site: { readonly meta: { readonly title: string | null, readonly description: string | null, readonly siteUrl: string | null, readonly author: string | null, readonly twitter: string | null, readonly adsense: string | null } | null } | null, readonly post: { readonly id: string, readonly html: string | null, readonly frontmatter: { readonly layout: string | null, readonly title: string | null, readonly path: string | null, readonly category: string | null, readonly tags: ReadonlyArray<string | null> | null, readonly description: string | null, readonly image: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } | null };
