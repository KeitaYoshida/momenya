...
type usersimackyDevmomenyasrccomponentsinstagramgetDataTsx1564155011QueryVariables = Exact<{ [key: string]: never; }>;


type usersimackyDevmomenyasrccomponentsinstagramgetDataTsx1564155011Query = { readonly allInstagramContent: { readonly edges: ReadonlyArray<{ readonly node: (
